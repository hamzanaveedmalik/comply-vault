export const usPricingContent = {
  hero: {
    ...
    description: 'Choose the plan that fits your RIA firm. No hidden fees or long-term commitments.',
  },
  faqs: [
    {
  ...
  guarantee: {
    ...
    description: 'If you\'re not completely satisfied with Comply Vault within the first 30 days, let us know and we\'ll refund your payment. No questions asked.',
  },
}
